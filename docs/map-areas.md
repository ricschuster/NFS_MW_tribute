...
| Halloway Quarry | quarry | ✓ connected, no orphans (#323) | n/a | ✓ plant and shed on the floor, yard on the rim | ✓ gravel haul, rim and access roads, no lamps or public traffic (#327) | ◐ 89 placed, in the editor | ◐ collectibles, breakables and a gate, no event | ✗ | In progress |
