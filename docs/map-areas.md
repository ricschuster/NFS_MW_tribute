...
| Halloway Quarry | quarry | ✓ connected, no orphans (#323) | n/a | ✓ plant and shed on the floor, yard on the rim | ✓ dirt haul, rim and access roads, no lamps in the pit | ◐ 50 placed, first pass, in the editor | ◐ collectibles, breakables and a gate, no event | ✗ | In progress |
