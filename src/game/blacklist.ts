/** One Blacklist rival. Ranks run 15 (first challenge) down to 1 (the boss). */
...
/**
 * The 15-strong Blacklist, ordered as you face them (rank 15 first). Names and
 * cars are original to keep this an unencumbered fan tribute.
 */
export const BLACKLIST: Rival[] = [
  ...
  { rank: 1, name: 'Reaper', car: 'The Most Wanted', color: '#e8462b', difficulty: 1.0 },
];
